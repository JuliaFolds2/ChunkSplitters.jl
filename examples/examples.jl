...
@btime uneven_workload_threads($x, $work_load; nchunks=nthreads(), chunk_type=:batch)
@btime uneven_workload_threads($x, $work_load; nchunks=nthreads(), chunk_type=:scatter)

@btime uneven_workload_threads($x, $work_load; nchunks=8 * nthreads(), chunk_type=:batch)
@btime uneven_workload_threads($x, $work_load; nchunks=8 * nthreads(), chunk_type=:scatter)
...
@btime uneven_workload_spawn($x, $work_load; nchunks=nthreads(), chunk_type=:batch)
@btime uneven_workload_spawn($x, $work_load; nchunks=nthreads(), chunk_type=:scatter)

@btime uneven_workload_spawn($x, $work_load; nchunks=8 * nthreads(), chunk_type=:batch)
@btime uneven_workload_spawn($x, $work_load; nchunks=8 * nthreads(), chunk_type=:scatter)
